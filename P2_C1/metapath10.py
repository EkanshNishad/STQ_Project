...
def Metapath10(collection, project_name):
    global db, project, dev_names, inte_names, U_dev_file, U_file_dev, U_file_pr, U_pr_file, U_pr_int, U_int_pr
...
print(m10_q1(project))

print("Question 2: ", end='')
print(m10_q2(project))

print("Question 3: ", end='')
print(m10_q3(project))

print("Question 7: ", end='')
print(m10_q7(project))

print("Question 8: ", end='')
print(m10_q8(project))

print("Question 9: ", end='')
print(m10_q9(project))

print("Question 10: ", end='')
print(m10_q10(project))