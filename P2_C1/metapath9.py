...
class Metapath9:
    ...
    def q1(self):
        metapath1 = np.matmul(self.U_dev_pr, np.matmul(self.U_pr_file, np.matmul(self.U_file_pr, self.U_pr_int)))
        metapath2 = np.matmul(self.U_int_pr, np.matmul(self.U_pr_file, np.matmul(self.U_file_pr, self.U_pr_dev)))
    ...
    def q2(self):
        ...
        metapath1 = np.matmul(self.U_dev_pr, np.matmul(M_pr_pr, np.matmul(M_pr_pr,
        np.matmul(self.U_pr_file, np.matmul(self.U_file_pr, self.U_pr_int)))))
        metapath2 = np.matmul(self.U_int_pr, np.matmul(M_pr_pr, np.matmul(M_pr_pr,
        np.matmul(self.U_pr_file, np.matmul(self.U_file_pr, self.U_pr_dev)))))
...
if __name__ == "__main__":
    ...
    mp2 = Metapath9("smartshark", project)
