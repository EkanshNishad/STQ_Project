...
def Metapath7(collection, project_name):
    global db, project, U_dev_file, U_file_dev, U_file_pr, U_pr_file, U_pr_prr, U_prr_pr, U_prr_rev, U_rev_prr
    global dev_names, rev_names
